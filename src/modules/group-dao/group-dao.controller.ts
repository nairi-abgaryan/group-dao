...
import { CreateGroupDaoDto } from './dto/create-group-dao.dto'
...
export class GroupDaoController {
  ...
  async createProposal(@Headers() headers: any, @Body() groupDaoRequest: CreateGroupDaoDto): Promise<void> {
    return this.appService.createProposal(groupDaoRequest.group_uuid, headers.authorization)
  }
}
